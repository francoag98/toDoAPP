  ...
  return (
    <main className="flex flex-col h-screen w-full m-0 bg-video">
      ...
      <div className="flex flex-col sm:mt-9 md:mt-0">
        ...
        <div className="text-center m-auto -mt-3 sm:-mt-10">
          <p className="font-sans font-bold text-sm sm:text-2xl text-green-700 sm:pl-5 sm:pr-4 pr-3 pl-3 bg-white mr-2 ml-3">
            TO TODO APP
          </p>
        </div>
      </div>
